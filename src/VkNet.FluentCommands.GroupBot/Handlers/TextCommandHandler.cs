...
{
    internal class TextCommandHandler : ICommandHandler<MessageToProcess>
    {
        private readonly TextCommandsStore _commandsStore;

        public TextCommandHandler(TextCommandsStore commandsStore)
        {
